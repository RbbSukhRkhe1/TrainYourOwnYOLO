...
def _main():
    ...
    checkpoint = ModelCheckpoint(
        ...
        save_best_only=True,
        # period parameter is deprecated in TF 2.x
    )
    ...
    if True:
        ...
        if not os.path.isfile("bottlenecks.npz"):
            ...
            batch_size = 8
            bottlenecks = bottleneck_model.predict(
        ...
        model.save_weights(log_dir + "trained_weights_stage_0.weights.h5")
